...
Die Internet Architektur nutzt größtenteils ein verbindungsloses Transportsystem beschrieben durch das TCP Protokoll in der Transportschicht. Diese Architektur hat vor allem aufgrund des verbindungslosen Designs, der Flexibilität und der Robustheit viele Vorteile, allerdings auch folgende Nachteile \cite{Braden1998}:
\begin{itemize}
